...
<body>
    ...
    <div class="center">
		...
		<br>
		<br>
		<info>Select employee from an outlet to transfer to another outlet</info>
		<br>
        <br>
		...
		<br>
        <form action="process-transfer.php">
            Outlet Number:
			<br>
			...
			Employee Number:
			<br>
            <input type="text" name="number" value=<?php if(empty($_POST['outletNum'])){$outlet=16988;} else{$outlet=$_POST['outletNum'];} currentEmployeeID($outlet); ?>>
            <br>
			Transfer Outlet:
			<br>
			<input type="text" name="transfer" value="22222">
			<br>
            <br>
            <input type="submit">
        </form>
